...
class MedicosASListAdapter (var agendaList: List<AgendaModel>): RecyclerView.Adapter<MedicosASListAdapter.AgendaListViewHolder>(){
    ...
    class AgendaListViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(agendaModel: AgendaModel){
            ...
            itemView.single_item_title.setOnClickListener {
                ...
                intent.putExtra("id", agendaModel.id_paciente)
